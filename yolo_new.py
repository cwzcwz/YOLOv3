...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class == "person" or predicted_class == "car" or predicted_class == "truck" or predicted_class == "motorbike" or predicted_class == "bus":
                box = out_boxes[i]
                score = out_scores[i]
...
def detect_img(yolo):
    ...
    for filename in image_names:
        ...
        try:
            ...
            image.save(os.path.join("./images/out2", filename), quality=90)
    #           r_image.show()
    yolo.close_session()
